...
$(function () {
    ...
    $(".Hui-aside").on("click", ".menu_dropdown dt", function () {
        ...
        if($(this).hasClass('selected')){
            ...
            $(this).nextAll().slideUp('first').removeClass('selected');
            ...
            $(this).nextAll().slideDown('first').addClass('selected');

        }



        // if ($('.menu_dropdown dt i,.menu_dropdown dd').hasClass('selected')) {
        //
        //     $('.menu_dropdown dt i,.menu_dropdown dt').removeClass('selected');
        //
        //     $('.menu_dropdown dd').removeClass('selected');
        //
        // } else {
        //
        //     $('.menu_dropdown dt i,.menu_dropdown dd').addClass('selected');
        //
        //     $('.menu_dropdown dd').removeClass('selected');
        //
        // }
